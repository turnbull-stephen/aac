...
import TenSrMplsL3outsNodeProfilesInterfaceProfilesInterfaces from './TenSrMplsL3outsNodeProfilesInterfaceProfilesInterfaces'


const TenSrMplsL3outsNodeProfilesInterfaceProfiles = React.memo(({ control, register, errors, clearErrors, setError, name }) => {
    ...
    <>
      {fields.length === 0 ? (
        ...
        paginatedFields.map((item, index) => {
          ...
          const isTenSrMplsL3outsNodeProfilesInterfaceProfilesInterfacesActive = activeKeys[item.id] === 'tensrmplsl3outsnodeprofilesinterfaceprofilesinterfaces';
            ...
            <div key={item.id}>
              <Accordion className='mb-2'>
                <Accordion.Item eventKey={originalIndex.toString()}>
                  ...
                  <Accordion.Body>
                    <Tabs
                      activeKey={activeKeys[item.id] || 'tensrmplsl3outsnodeprofilesinterfaceprofiles'}
                    ...
                    >
                      <Tab eventKey="tensrmplsl3outsnodeprofilesinterfaceprofiles" title="Interface Profiles">
                        <Card>
                          <Card.Body>
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(400px, 1fr))', gridGap: '1rem' }}>
                              {Object.entries(get(schema, 'tenant.ten_sr_mpls_l3outs_node_profiles_interface_profiles', {})).map(([objectKey, value]) => (
                                <ArrayFunctions
                                  key={objectKey} 
                        ...
                        {isTenSrMplsL3outsNodeProfilesInterfaceProfilesInterfacesActive && (  
                            <TenSrMplsL3outsNodeProfilesInterfaceProfilesInterfaces
                              key={item.id}
                              control={control}
...
export default TenSrMplsL3outsNodeProfilesInterfaceProfiles;
