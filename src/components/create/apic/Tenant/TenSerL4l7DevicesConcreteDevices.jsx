...
import TenSerL4l7DevicesConcreteDevicesInterfaces from './TenSerL4l7DevicesConcreteDevicesInterfaces'


const TenSerL4l7DevicesConcreteDevices = React.memo(({ control, register, errors, clearErrors, setError, name }) => {
    ...
    <>
      {fields.length === 0 ? (
        ...
        paginatedFields.map((item, index) => {
          ...
          const isTenSerL4l7DevicesConcreteDevicesInterfacesActive = activeKeys[item.id] === 'tenserl4l7devicesconcretedevicesinterfaces';
            ...
            <div key={item.id}>
              <Accordion className='mb-2'>
                <Accordion.Item eventKey={originalIndex.toString()}>
                  ...
                  <Accordion.Body>
                    <Tabs
                      activeKey={activeKeys[item.id] || 'tenserl4l7devicesconcretedevices'}
                    ...
                    >
                      <Tab eventKey="tenserl4l7devicesconcretedevices" title="Concrete Devices">
                        <Card>
                          <Card.Body>
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(400px, 1fr))', gridGap: '1rem' }}>
                              {Object.entries(get(schema, 'tenant.ten_ser_l4l7_devices_concrete_devices', {})).map(([objectKey, value]) => (
                                <ArrayFunctions
                                  key={objectKey} 
                        ...
                        <Tab eventKey="tenserl4l7devicesconcretedevicesinterfaces" title="Interfaces">
                        {isTenSerL4l7DevicesConcreteDevicesInterfacesActive && (  
                            <TenSerL4l7DevicesConcreteDevicesInterfaces
                              key={item.id}
                              control={control}
...
export default TenSerL4l7DevicesConcreteDevices;
