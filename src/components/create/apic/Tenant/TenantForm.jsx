        ...
        <Row>
          <SplitPane style={{ maxHeight: "94%", maxWidth: "100%" }} split="vertical" minSize={100} defaultSize={"30%"}>
            <div style={{ width: '100%', height: '100%', position: 'relative' }}>
              ...
              <SplitPane split="horizontal" defaultSize={500} style={{ position: 'relative', height: 'calc(100% - 100px)' }} onChange={debouncedSetEditorHeight}>
                <MonacoYamlEditor
                  name={yamlEditData} // The name of the field that holds the YAML/JSON data
                  editorRef={editorRef}
                />
                <div className='mt-2'>
