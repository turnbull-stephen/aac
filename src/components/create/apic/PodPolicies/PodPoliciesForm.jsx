...
const PodPoliciesForm = () => {
      ...
      if (fileExtension === 'yaml' || fileExtension === 'yml') {
        ...
        reader.onload = (event) => {
          try {
            ...
            reset(loadedData.apic.pod_policies);
            onSubmit(loadedData.apic.pod_policies)
  ...
  // Define the Root for apic/pod_policies
  ...
  const onSubmit = (data) => {
    ...
    root.apic.pod_policiess = processedData;
    
    // To display the YAML representation of the pod_policies array,
  ...
  const [key, setKey] = useState('pppod'); // Keep state for the Tab selection
  


  const hasPpPodErrors = Boolean(errors.pods);
    ...
    <div className="full-height-layout">
      <Container fluid>
        <Row>
          <Col md={3}>
            <div>
              <label>Load Pod Policies Data:</label>
          ...
          <Col md={9}>
            <div >
            <h3 className='mt-2'>Pod Policies</h3>
                  ...
                  <Card>
                    <Card.Body>
                      <Tabs
                        ...
                        //fill
                      >
                        <Tab eventKey="pppod" title={tabTitle('Pods', hasPpPodErrors)}>
                          <Card>
                            <Card.Body>
                            <PpPod control={control} register={register} errors={errors} clearErrors={clearErrors} setError={setError} name={'pods'} getValues={getValues} setValue={setValue} watch={watch} />
                            </Card.Body>
                          </Card>
                        </Tab>
                        </Tabs>
...
export default PodPoliciesForm;
