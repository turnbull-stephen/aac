...
import FabricConnectivity from './FabricConnectivity';
...
const NdoForm = () => {
      ...
      if (fileExtension === 'yaml' || fileExtension === 'yml') {
        ...
        reader.onload = (event) => {
          try {
            ...
            reset(loadedData.ndo);
            onSubmit(loadedData.ndo)
            
            setSnackbarMessage('Loaded Successful!');
            setSnackbarSeverity('success');
            setOpenSnackbar(true);
          } catch (error) {
            console.error('Failed to parse YAML:', error);
            setSnackbarMessage('Loaded Failed!');
  ...
  const onSubmit = (data) => {
    ...
    root.ndo = processedData;
    
    // To display the YAML representation of the ndo array,
  ...
  const [key, setKey] = useState('ndo'); // Keep state for the Tab selection
  


  const hasNdoErrors =Boolean(errors.version);
  const hasSystemConfigErrors = Boolean(errors.system_config);
  const hasRemoteLocationsErrors = Boolean(errors.remote_locations);
  const hasSitesErrors = Boolean(errors.sites);
  const hasFabricConnectivityErrors = Boolean(errors.fabric_connectivity);
  const hasTenantsErrors = Boolean(errors.tenants);
  const hasPoliciesErrors = Boolean(errors.policies);
  const hasSchemasErrors = Boolean(errors.schemas);
                  ...
                  <Card>
                    <Card.Body>
                      <Tabs
                        ...
                        //fill
                      >
                        <Tab eventKey="ndo" title={tabTitle('Ndo', hasNdoErrors)}>
                          <Card>
                            <Card.Body>
                            <Ndo control={control} register={register} errors={errors} clearErrors={clearErrors} setError={setError} name={'ndo'} getValues={getValues} setValue={setValue} watch={watch} />
                            </Card.Body>
                          </Card>
                        </Tab>
                        <Tab eventKey="systemconfig" title={tabTitle('System Config', hasSystemConfigErrors)}>
                          <Card>
                            <Card.Body>
                            <SystemConfig control={control} register={register} errors={errors} clearErrors={clearErrors} setError={setError} name={'system_config'} getValues={getValues} setValue={setValue} watch={watch} />
                            </Card.Body>
                          </Card>
                        </Tab>
                        <Tab eventKey="remotelocations" title={tabTitle('Remote Locations', hasRemoteLocationsErrors)}>
                          <Card>
                            <Card.Body>
                            <RemoteLocations control={control} register={register} errors={errors} clearErrors={clearErrors} setError={setError} name={'remote_locations'} getValues={getValues} setValue={setValue} watch={watch} />
                            </Card.Body>
                          </Card>
                        </Tab>
                        <Tab eventKey="sites" title={tabTitle('Sites', hasSitesErrors)}>
                          <Card>
                            <Card.Body>
                            <Sites control={control} register={register} errors={errors} clearErrors={clearErrors} setError={setError} name={'sites'} getValues={getValues} setValue={setValue} watch={watch} />
                            </Card.Body>
                          </Card>
                        </Tab>
                        <Tab eventKey="fabricconnectivity" title={tabTitle('Fabric Connectivity', hasFabricConnectivityErrors)}>
                          <Card>
                            <Card.Body>
                            <FabricConnectivity control={control} register={register} errors={errors} clearErrors={clearErrors} setError={setError} name={'fabric_connectivity'} getValues={getValues} setValue={setValue} watch={watch} />
                            </Card.Body>
                          </Card>
                        </Tab>
                        <Tab eventKey="tenants" title={tabTitle('Tenants', hasTenantsErrors)}>
                          <Card>
                            <Card.Body>
                            <Tenants control={control} register={register} errors={errors} clearErrors={clearErrors} setError={setError} name={'tenants'} getValues={getValues} setValue={setValue} watch={watch} />
                            </Card.Body>
                          </Card>
                        </Tab>
                        <Tab eventKey="policies" title={tabTitle('Policies', hasPoliciesErrors)}>
                          <Card>
                            <Card.Body>
                            <Policies control={control} register={register} errors={errors} clearErrors={clearErrors} setError={setError} name={'policies'} getValues={getValues} setValue={setValue} watch={watch} />
                            </Card.Body>
                          </Card>
                        </Tab>
                        </Tabs>
