...
import TenL3outsNodeProfilesInterfaceProfilesInterfacesBgpPeers from './TenL3outsNodeProfilesInterfaceProfilesInterfacesBgpPeers'
import TenL3outsNodeProfilesInterfaceProfilesInterfacesPaths from './TenL3outsNodeProfilesInterfaceProfilesInterfacesPaths'
import TenL3outsNodeProfilesInterfaceProfilesInterfacesExpectedState from './TenL3outsNodeProfilesInterfaceProfilesInterfacesExpectedState'


const TenL3outsNodeProfilesInterfaceProfilesInterfaces = React.memo(({ control, register, errors, clearErrors, setError, name }) => {
    ...
    <>
      {fields.length === 0 ? (
        ...
        paginatedFields.map((item, index) => {
          ...
          const isTenL3outsNodeProfilesInterfaceProfilesInterfacesBgpPeersActive = activeKeys[item.id] === 'tenl3outsnodeprofilesinterfaceprofilesinterfacesbgppeers';
          const isTenL3outsNodeProfilesInterfaceProfilesInterfacesPathsActive = activeKeys[item.id] === 'tenl3outsnodeprofilesinterfaceprofilesinterfacespaths';
          const isTenL3outsNodeProfilesInterfaceProfilesInterfacesExpectedStateActive = activeKeys[item.id] === 'tenl3outsnodeprofilesinterfaceprofilesinterfacesexpectedstate';
            ...
            <div key={item.id}>
              <Accordion className='mb-2'>
                <Accordion.Item eventKey={originalIndex.toString()}>
                  ...
                  <Accordion.Body>
                    <Tabs
                      activeKey={activeKeys[item.id] || 'tenl3outsnodeprofilesinterfaceprofilesinterfaces'}
                      onSelect={(k) => handleTabChange(item.id, k)}
                      className="mb-2"
                      id={item.id}
                    >
                      <Tab eventKey="tenl3outsnodeprofilesinterfaceprofilesinterfaces" title="Interfaces">
                        <Card>
                          <Card.Body>
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(400px, 1fr))', gridGap: '1rem' }}>
                              {Object.entries(get(schema, 'tenant.ten_l3outs_node_profiles_interface_profiles_interfaces', {})).map(([objectKey, value]) => (
                                <ArrayFunctions
                                  key={objectKey} 
                        ...
                        <Tab eventKey="tenl3outsnodeprofilesinterfaceprofilesinterfacesbgppeers" title="Bgp Peers">
                        {isTenL3outsNodeProfilesInterfaceProfilesInterfacesBgpPeersActive && (  
                            <TenL3outsNodeProfilesInterfaceProfilesInterfacesBgpPeers
                              key={item.id}
                              control={control}
                        ...
                        <Tab eventKey="tenl3outsnodeprofilesinterfaceprofilesinterfacespaths" title="Paths">
                        {isTenL3outsNodeProfilesInterfaceProfilesInterfacesPathsActive && (  
                            <TenL3outsNodeProfilesInterfaceProfilesInterfacesPaths
                              key={item.id}
                              control={control}
                              name={`${name}[${originalIndex}].paths`}
                              register={register}
                              errors={errors}
                              setError={setError}
                              clearErrors={clearErrors}
                        ...
                        <Tab eventKey="tenl3outsnodeprofilesinterfaceprofilesinterfacesexpectedstate" title="Expected State">
                        {isTenL3outsNodeProfilesInterfaceProfilesInterfacesExpectedStateActive && (  
                            <TenL3outsNodeProfilesInterfaceProfilesInterfacesExpectedState
                              key={item.id}
                              control={control}
...
export default TenL3outsNodeProfilesInterfaceProfilesInterfaces;
