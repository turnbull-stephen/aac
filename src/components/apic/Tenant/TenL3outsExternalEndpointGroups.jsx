...
import TenL3outsExternalEndpointGroupsSubnets from './TenL3outsExternalEndpointGroupsSubnets'
import TenL3outsExternalEndpointGroupsContracts from './TenL3outsExternalEndpointGroupsContracts'
import TenL3outsExternalEndpointGroupsRouteControlProfiles from './TenL3outsExternalEndpointGroupsRouteControlProfiles'
import TenL3outsExternalEndpointGroupsExpectedState from './TenL3outsExternalEndpointGroupsExpectedState'


const TenL3outsExternalEndpointGroups = React.memo(({ control, register, errors, clearErrors, setError, name }) => {
    ...
    <>
      {fields.length === 0 ? (
        ...
        paginatedFields.map((item, index) => {
          ...
          const isTenL3outsExternalEndpointGroupsSubnetsActive = activeKeys[item.id] === 'tenl3outsexternalendpointgroupssubnets';
          const isTenL3outsExternalEndpointGroupsContractsActive = activeKeys[item.id] === 'tenl3outsexternalendpointgroupscontracts';
          const isTenL3outsExternalEndpointGroupsRouteControlProfilesActive = activeKeys[item.id] === 'tenl3outsexternalendpointgroupsroutecontrolprofiles';
          const isTenL3outsExternalEndpointGroupsExpectedStateActive = activeKeys[item.id] === 'tenl3outsexternalendpointgroupsexpectedstate';
            ...
            <div key={item.id}>
              <Accordion className='mb-2'>
                <Accordion.Item eventKey={originalIndex.toString()}>
                  ...
                  <Accordion.Body>
                    <Tabs
                      activeKey={activeKeys[item.id] || 'tenl3outsexternalendpointgroups'}
                    ...
                    >
                      <Tab eventKey="tenl3outsexternalendpointgroups" title="External Endpoint Groups">
                        <Card>
                          <Card.Body>
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(400px, 1fr))', gridGap: '1rem' }}>
                              {Object.entries(get(schema, 'tenant.ten_l3outs_external_endpoint_groups', {})).map(([objectKey, value]) => (
                                <ArrayFunctions
                                  key={objectKey} 
                        ...
                        <Tab eventKey="tenl3outsexternalendpointgroupssubnets" title="Subnets">
                        {isTenL3outsExternalEndpointGroupsSubnetsActive && (  
                            <TenL3outsExternalEndpointGroupsSubnets
                              key={item.id}
                              control={control}
                        ...
                        <Tab eventKey="tenl3outsexternalendpointgroupscontracts" title="Contracts">
                        {isTenL3outsExternalEndpointGroupsContractsActive && (  
                            <TenL3outsExternalEndpointGroupsContracts
                              key={item.id}
                              control={control}
                        ...
                        <Tab eventKey="tenl3outsexternalendpointgroupsroutecontrolprofiles" title="Route Control Profiles">
                        {isTenL3outsExternalEndpointGroupsRouteControlProfilesActive && (  
                            <TenL3outsExternalEndpointGroupsRouteControlProfiles
                              key={item.id}
                              control={control}
                              name={`${name}[${originalIndex}].route_control_profiles`}
                              register={register}
                              errors={errors}
                              setError={setError}
                              clearErrors={clearErrors}
                        ...
                        <Tab eventKey="tenl3outsexternalendpointgroupsexpectedstate" title="Expected State">
                        {isTenL3outsExternalEndpointGroupsExpectedStateActive && (  
                            <TenL3outsExternalEndpointGroupsExpectedState
                              key={item.id}
                              control={control}
...
export default TenL3outsExternalEndpointGroups;
