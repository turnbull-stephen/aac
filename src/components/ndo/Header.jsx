...
const result = (firstResult && secondResult) ? `${firstResult} ${secondResult}` : firstResult || secondResult;
  ...
  const displayValue = nameValue || idValue || channelValue || result || nodeIdValue || ipValue || groupPrefixValue || prefixValue || dhcpRelayPolicyValue || keyValue || valueValue || routeMapValue || filterValue || communityValue || orderValue || priorityValue;
    ...
    <div style={{ display: 'flex', justifyContent: 'space-between', width: '100%' }}>
      <div style={{ display: 'flex' }}>
        <div style={{ position: 'relative', display: 'inline-block' }}>
          ...
          {hasErrors &&
            <span style={{ position: 'absolute', top: -10, right: 6, zIndex: 9999 }}>
              <Badge >
